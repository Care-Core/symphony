defmodule SymphonyElixir.HoldStore do
  ...
  def persist_progress(workspace_root, progress)
      when is_binary(workspace_root) and is_map(progress) do
  ...
  defp validate_progress_watcher(watcher) when is_map(watcher), do: :ok
