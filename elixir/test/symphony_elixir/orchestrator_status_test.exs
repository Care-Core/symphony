defmodule SymphonyElixir.OrchestratorStatusTest do
  ...
  test "orchestrator snapshot tracks camelCase codex rate-limit payloads" do
    ...
    issue = %Issue{
      ...
      description: "Capture codex rate limit state from account updates",
      state: "In Progress",
      url: "https://example.org/issues/MT-221B"
    }

    orchestrator_name = Module.concat(__MODULE__, :CamelCaseRateLimitOrchestrator)
    {:ok, pid} = Orchestrator.start_link(name: orchestrator_name)
    ...
    rate_limits = %{
      ...
      "secondary" => %{"used_percent" => 17.0, "window_minutes" => 10_080},
      "credits" => nil
    }
